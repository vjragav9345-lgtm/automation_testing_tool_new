"""
Auto-generated from recording: session_20260818_152912
Generated at: 2026-08-18T15:29:12.784970
...
Run directly with: python session_20260818_152912_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        ...
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:27.179Z',
        'new_tab': None},
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': None,
        ...
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:29.049Z',
        'new_tab': None},
    {   'action_type': 'fill',
        'value': 'mouse',
        'locator_profile': {   'id': None,
        ...
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:32.880Z',
        'new_tab': None},
    {   'action_type': 'press',
        'value': 'Enter',
        'locator_profile': {   'id': None,
        ...
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:32.881Z',
        'new_tab': None},
    {   'action_type': 'navigate',
        'value': None,
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/search?q=mouse&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off',
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:38.546Z',
        'new_tab': None},
    {   'action_type': 'scroll',
        'value': None,
        'locator_profile': {},
        ...
        'delta_x': 0,
        'delta_y': 1535,
        'timestamp': '2026-08-18T09:58:38.850Z',
        'new_tab': None},
    {   'action_type': 'scroll',
        'value': None,
        'locator_profile': {},
        ...
        'delta_x': 0,
        'delta_y': 230,
        'timestamp': '2026-08-18T09:58:39.766Z',
        'new_tab': None},
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': None,
                               'css_path': 'div#container > div > div:nth-of-type(3) > div > '
                                           ...
                                           'div > a > div > div > div > img',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[5]/div[1]/div[1]/div[1]/a[1]/div[1]/div[1]/div[1]/img[1]',
                               'text': '',
                               'tag': 'img',
                               'attributes': {}},
        'bounding_box': {   'x': 308.8999938964844,
                            'y': 211.6374969482422,
                            'width': 200,
                            'height': 200},
        'page_url': 'https://www.flipkart.com/search?q=mouse&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off',
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:43.938Z',
        'new_tab': None},
    {   'action_type': 'navigate',
        'value': None,
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/zebronics-zeb-phero-wired-ambidextrous-optical-gaming-mouse-dpi-switch-high-precision-plug-play-4-buttons/p/itmf83719b72e06f?pid=ACCHFGEK5GZ3WJNQ&lid=LSTACCHFGEK5GZ3WJNQYGIWIX&marketplace=FLIPKART&q=mouse&store=6bo%2Ftia%2F8pp%2Fp0w&spotlightTagId=default_BestsellerId_6bo%2Ftia%2F8pp%2Fp0w&srno=s_1_13&otracker=search&otracker1=search&fm=Search&iid=04003741-5021-4033-895b-cfc8d22b419a.ACCHFGEK5GZ3WJNQ.SEARCH&ppt=sp&ppn=sp&ssid=qy9lkdkocw0000001787047114323&qH=40203abe6e81ed98&ov_redirect=true&ov_redirect=true',
        'delta_x': None,
        'delta_y': None,
        'timestamp': '2026-08-18T09:58:45.565Z',
        'new_tab': True}]
PROD_URL = "https://www.flipkart.com/"
SOURCE_NAME = "session_20260818_152912"
    ...
    with sync_playwright() as p:
        ...
        for i, step in enumerate(STEPS, start=1):
            ...
            try:
                ...
                # zero-padded index + action type (+ _FAILED when it
                # didn't succeed) - traceable to exactly which step
                # produced it, unlike a bare "step3.png"
                suffix = "" if ok else "_FAILED"
                shot_path = shot_dir / f"{i:03d}_{action_type}{suffix}.png"
                try:
                    page.screenshot(path=str(shot_path))
                ...
                if ok:
                    ...
                    if lp:
                        available = [
                            k for k in ("id", "css_path", "xpath", "text")
                            if lp.get(k)
                        ]
                        print(f"Locator fields available: {available or 'none'}")
                    if shot_str:
