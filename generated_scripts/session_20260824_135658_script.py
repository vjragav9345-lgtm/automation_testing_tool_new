"""
Auto-generated from recording: session_20260824_135658
Generated at: 2026-08-24T13:56:58.105755
...
Run directly with: python session_20260824_135658_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        ...
        'timestamp': '2026-08-24T08:26:04.871Z',
        'delay_before_ms': 0,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:07.776Z',
        'delay_before_ms': 2905,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:09.743Z',
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:24.315Z',
        'delay_before_ms': 14572,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'fill',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:31.290Z',
        'delay_before_ms': 6975,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:31.516Z',
        'delay_before_ms': 226,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:36.238Z',
        'delay_before_ms': 4722,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:38.290Z',
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:44.398Z',
        'delay_before_ms': 6108,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'fill',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:48.066Z',
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:48.296Z',
        'delay_before_ms': 230,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'tab_close',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T08:26:58.065Z',
        'delay_before_ms': 9769,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
...
SOURCE_NAME = "session_20260824_135658"
...
def _validate_product(page, product_name, shot_dir, img_counter):
...
def run(qa_url, output_json_path=None, screenshot_dir=None, headless=True, product_name=None):
    ...
    with sync_playwright() as p:
        ...
        try:
            page.screenshot(path=str(_next_shot_path(shot_dir, img_counter)))
        except Exception:
            pass
        ...
        for i, step in enumerate(STEPS, start=1):
            ...
            try:
                ...
                # next image in this run's sequence - one per recorded
                # action, no exceptions, taken here regardless of action
                # type or success/failure (this line runs after the
                # action-type-specific handling above for every step,
                # already positioned after any settling that happened)
                shot_path = _next_shot_path(shot_dir, img_counter)
                try:
                    page.screenshot(path=str(shot_path))
        ...
        if final_page is not None:
            ...
            final_shot = _next_shot_path(shot_dir, img_counter)
            try:
        ...
        if product_name and product_name.strip() and page is not None:
            ...
            print("")
            try:
                pv = _validate_product(page, pname, shot_dir, img_counter)
            except Exception as e:
