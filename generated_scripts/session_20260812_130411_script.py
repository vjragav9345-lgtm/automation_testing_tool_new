"""
Auto-generated from recording: session_20260812_130411
Generated at: 2026-08-12T13:04:11.590229
Original recorded (production) URL: https://www.ebay.com/
...
Run directly with: python session_20260812_130411_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#gh-ac',
                               'css_path': 'input#gh-ac',
                               'xpath': "//*[@id='gh-ac']",
                               'text': '',
                               'tag': 'input',
                               'attributes': {   'title': 'Search',
                                                 ...
                                                 'name': '_nkw',
                                                 'role': 'combobox'}},
        'bounding_box': {   'x': 271.3999938964844,
                            'y': 51.29999923706055,
                            'width': 536.625,
    ...
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#gh-search-btn',
                               'css_path': 'button#gh-search-btn',
                               'xpath': "//*[@id='gh-search-btn']",
                               'text': 'Search',
                               'tag': 'button',
                               'attributes': {'type': 'submit', 'role': 'button'}},
        'bounding_box': {   'x': 985.2250366210938,
                            'y': 48.900001525878906,
                            'width': 168,
                            'height': 44},
        'page_url': 'https://www.ebay.com/',
        'delta_x': None,
    ...
    {   'action_type': 'navigate',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.ebay.com/sch/i.html?_nkw=wireless+mouse&_sacat=0&_from=R40&_trksid=m570.l1313',
        'delta_x': None,
        'delta_y': None}]
PROD_URL = "https://www.ebay.com/"
