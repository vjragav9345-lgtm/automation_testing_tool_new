"""
Auto-generated from recording: session_20260820_130002
Generated at: 2026-08-20T13:00:02.381345
...
Run directly with: python session_20260820_130002_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        ...
        'timestamp': '2026-08-20T07:28:53.340Z',
        'delay_before_ms': 0,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:28:54.757Z',
        'delay_before_ms': 1417,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'fill',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:28:59.373Z',
        'delay_before_ms': 4616,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'mouse wireless\nin Mouse',
                               'placeholder': None,
                               'title': None,
                               'href': '/search?q=mouse+wireless&sid=6bo%2Ctia%2C8pp%2Cp0w&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&as-pos=1&as-type=RECENT&suggestionId=mouse+wireless%7CMouse&requestId=0adb2f9f-ebb4-4f20-bc7c-70ce8ec2ef5e&as-searchtext=mouse',
                               'css_path': 'div#container > div > div > div > div > div > div > '
                                           'div > div > div > div > div > div > div > div > '
                                           'div:nth-of-type(2) > div > div > div > div > div > '
                               ...
                               'text': 'mouse wireless\nin Mouse',
                               'element_text': 'mouse wireless\nin Mouse',
                               'tag': 'a',
                               'attributes': {   'href': '/search?q=mouse+wireless&sid=6bo%2Ctia%2C8pp%2Cp0w&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&as-pos=1&as-type=RECENT&suggestionId=mouse+wireless%7CMouse&requestId=0adb2f9f-ebb4-4f20-bc7c-70ce8ec2ef5e&as-searchtext=mouse'}},
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:28:59.591Z',
        'delay_before_ms': 218,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/search?q=mouse+wireless&sid=6bo%2Ctia%2C8pp%2Cp0w&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&as-pos=1&as-type=RECENT&suggestionId=mouse+wireless%7CMouse&requestId=0adb2f9f-ebb4-4f20-bc7c-70ce8ec2ef5e&as-searchtext=mouse%20wireless',
        'delta_x': 0,
        'delta_y': 1211,
        'scroll_y_before': 0,
        'scroll_y_after': 968.7999877929688,
        'viewport_height': 720,
        'document_height': 6575,
        'timestamp': '2026-08-20T07:29:05.007Z',
        'delay_before_ms': 5416,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:05.333Z',
        'delay_before_ms': 326,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'Bestseller',
                               'placeholder': None,
                               'title': None,
                               'href': '/zebronics-pulse-ambidextrous-optical-mouse-1200dpi-dual-bt-multi-connect-lightweight-comfort/p/itm95ea8032bd846?pid=ACCGXZE9KMRQAYFY&lid=LSTACCGXZE9KMRQAYFYGJSFHP&marketplace=FLIPKART&q=mouse+wireless&store=6bo%2Ftia%2F8pp%2Fp0w&spotlightTagId=default_BestsellerId_6bo%2Ftia%2F8pp%2Fp0w&srno=s_1_10&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&fm=search-autosuggest&iid=3df3b334-bd08-47d5-a580-be84abb62594.ACCGXZE9KMRQAYFY.SEARCH&ppt=sp&ppn=sp&ssid=fwszm4rcr40000001787210941206&qH=802ebb943bb41273&ov_redirect=true&ov_redirect=true',
                               'css_path': 'div#container > div > div:nth-of-type(3) > div > '
                                           'div:nth-of-type(2) > div:nth-of-type(4) > div > '
                                           'div:nth-of-type(2) > div > a',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[3]/div[1]/div[2]/div[4]/div[1]/div[2]/div[1]/a[1]',
                               'text': 'Bestseller',
                               'element_text': 'Bestseller',
                               'tag': 'a',
                               'attributes': {   'href': '/zebronics-pulse-ambidextrous-optical-mouse-1200dpi-dual-bt-multi-connect-lightweight-comfort/p/itm95ea8032bd846?pid=ACCGXZE9KMRQAYFY&lid=LSTACCGXZE9KMRQAYFYGJSFHP&marketplace=FLIPKART&q=mouse+wireless&store=6bo%2Ftia%2F8pp%2Fp0w&spotlightTagId=default_BestsellerId_6bo%2Ftia%2F8pp%2Fp0w&srno=s_1_10&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&fm=search-autosuggest&iid=3df3b334-bd08-47d5-a580-be84abb62594.ACCGXZE9KMRQAYFY.SEARCH&ppt=sp&ppn=sp&ssid=fwszm4rcr40000001787210941206&qH=802ebb943bb41273&ov_redirect=true&ov_redirect=true'}},
        'bounding_box': {   'x': 545.7999877929688,
                            'y': 158.9875030517578,
                            'width': 209.8000030517578,
                            'height': 280},
        'page_url': 'https://www.flipkart.com/search?q=mouse+wireless&sid=6bo%2Ctia%2C8pp%2Cp0w&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&as-pos=1&as-type=RECENT&suggestionId=mouse+wireless%7CMouse&requestId=0adb2f9f-ebb4-4f20-bc7c-70ce8ec2ef5e&as-searchtext=mouse%20wireless',
        'delta_x': None,
        'delta_y': None,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:06.010Z',
        'delay_before_ms': 677,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'tab_open',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/zebronics-pulse-ambidextrous-optical-mouse-1200dpi-dual-bt-multi-connect-lightweight-comfort/p/itm95ea8032bd846?pid=ACCGXZE9KMRQAYFY&lid=LSTACCGXZE9KMRQAYFYGJSFHP&marketplace=FLIPKART&q=mouse+wireless&store=6bo%2Ftia%2F8pp%2Fp0w&spotlightTagId=default_BestsellerId_6bo%2Ftia%2F8pp%2Fp0w&srno=s_1_10&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&fm=search-autosuggest&iid=3df3b334-bd08-47d5-a580-be84abb62594.ACCGXZE9KMRQAYFY.SEARCH&ppt=sp&ppn=sp&ssid=fwszm4rcr40000001787210941206&qH=802ebb943bb41273&ov_redirect=true&ov_redirect=true',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:09.361Z',
        'delay_before_ms': 3351,
        'new_tab': True,
        'page_id': 1,
        'from_page_id': 0,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:10.168Z',
        'delay_before_ms': 807,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:12.767Z',
        'delay_before_ms': 2599,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:13.617Z',
        'delay_before_ms': 850,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:16.764Z',
        'delay_before_ms': 3147,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:17.714Z',
        'delay_before_ms': 950,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'tag': 'div',
                               'attributes': {}},
        'bounding_box': {   'x': 320.5375061035156,
                            'y': 501.20001220703125,
                            'width': 254.9375,
                            'height': 46},
        'page_url': 'https://www.flipkart.com/viewcart?exploreMode=TRUE&preference=FLIPKART&pageUID=1787210957727',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:21.967Z',
        'delay_before_ms': 4253,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:22.585Z',
        'delay_before_ms': 618,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:29.284Z',
        'delay_before_ms': 6699,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:30.101Z',
        'delay_before_ms': 817,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:32.236Z',
        'delay_before_ms': 2135,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'aria_label': None,
                               'accessible_name': '4.2\n'
                                                  'Frontech Dual Connectivity Wireless Mouse | RGB '
                                                  '| 1600 DPI | 400mAh Recharge',
                               'placeholder': None,
                               'title': None,
                               'href': '/frontech-dual-connectivity-wireless-mouse-rgb-1600-dpi-400mah-rechargeable-battery-ambidextrous-optical/p/itm386fbd2134f00?pid=ACCHZZNFCHZ7QRNY&lid=LSTACCHZZNFCHZ7QRNYCCK5BC&hl_lid=&marketplace=FLIPKART&fm=eyJ3dHAiOiJyZWNvIiwicHJwdCI6InBwIiwibWlkIjoicHJvZHVjdFJlY29tbWVuZGF0aW9uL2FzcGVjdFNpbWlsYXIifQ%3D%3D',
                               'css_path': 'div#slot-list-container > div > div:nth-of-type(2) > '
                                           'div > div > div > div:nth-of-type(3) > div > div > div '
                                           '> div > div > div > div > div:nth-of-type(2) > div > '
                                           'div > div > div:nth-of-type(4) > div > a',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[4]/div[1]/a[1]',
                               'text': '4.2\n'
                                       'Frontech Dual Connectivity Wireless Mouse | RGB | 1600 DPI '
                                       '| 400mAh Recharge',
                               'element_text': '4.2\n'
                                               'Frontech Dual Connectivity Wireless Mouse | RGB | '
                                               '1600 DPI | 400mAh Recharge',
                               'tag': 'a',
                               'attributes': {   'href': '/frontech-dual-connectivity-wireless-mouse-rgb-1600-dpi-400mah-rechargeable-battery-ambidextrous-optical/p/itm386fbd2134f00?pid=ACCHZZNFCHZ7QRNY&lid=LSTACCHZZNFCHZ7QRNYCCK5BC&hl_lid=&marketplace=FLIPKART&fm=eyJ3dHAiOiJyZWNvIiwicHJwdCI6InBwIiwibWlkIjoicHJvZHVjdFJlY29tbWVuZGF0aW9uL2FzcGVjdFNpbWlsYXIifQ%3D%3D'}},
        'bounding_box': {   'x': 743,
                            'y': 273.7250061035156,
                            'width': 205,
                            'height': 383.32501220703125},
        'page_url': 'https://www.flipkart.com/zebronics-pulse-ambidextrous-optical-mouse-1200dpi-dual-bt-multi-connect-lightweight-comfort/p/itm95ea8032bd846?pid=ACCGXZE9KMRQAYFY&lid=LSTACCGXZE9KMRQAYFYGJSFHP&marketplace=FLIPKART&q=mouse+wireless&store=6bo%2Ftia%2F8pp%2Fp0w&spotlightTagId=default_BestsellerId_6bo%2Ftia%2F8pp%2Fp0w&srno=s_1_10&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&fm=search-autosuggest&iid=3df3b334-bd08-47d5-a580-be84abb62594.ACCGXZE9KMRQAYFY.SEARCH&ppt=sp&ppn=sp&ssid=fwszm4rcr40000001787210941206&qH=802ebb943bb41273&ov_redirect=true&ov_redirect=true',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:32.950Z',
        'delay_before_ms': 714,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/frontech-dual-connectivity-wireless-mouse-rgb-1600-dpi-400mah-rechargeable-battery-ambidextrous-optical/p/itm386fbd2134f00?pid=ACCHZZNFCHZ7QRNY&lid=LSTACCHZZNFCHZ7QRNYCCK5BC&hl_lid=&marketplace=FLIPKART&fm=eyJ3dHAiOiJyZWNvIiwicHJwdCI6InBwIiwibWlkIjoicHJvZHVjdFJlY29tbWVuZGF0aW9uL2FzcGVjdFNpbWlsYXIifQ%3D%3D&pageUID=1787210972975',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:37.501Z',
        'delay_before_ms': 4551,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'tab_close',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:38.121Z',
        'delay_before_ms': 620,
        'new_tab': None,
        'page_id': 1,
        'from_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 5522,
        'scroll_y_before': 968.7999877929688,
        'scroll_y_after': 5387.2001953125,
        'viewport_height': 720,
        'document_height': 6575,
        'timestamp': '2026-08-20T07:29:43.458Z',
        'delay_before_ms': 5337,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'Interface: 2.4GHz Wireless',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'css_path': 'div#container > div > div:nth-of-type(3) > '
                                           'div:nth-of-type(2) > div > div:nth-of-type(4) > div > '
                                           'div:nth-of-type(2) > ul > li:nth-of-type(2)',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[4]/div[1]/div[2]/ul[1]/li[2]',
                               'text': 'Interface: 2.4GHz Wireless',
                               'element_text': 'Interface: 2.4GHz Wireless',
                               'tag': 'li',
                               'attributes': {}},
        'bounding_box': {   'x': 219.9875030517578,
                            'y': 225.46250915527344,
                            'width': 286.88751220703125,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:44.573Z',
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'EVM Classy Ambidextrous Optical Mouse 3600 DPI '
                                                  '6-Button RGB LED',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'css_path': 'div#container > div > div:nth-of-type(3) > '
                                           'div:nth-of-type(2) > div > div:nth-of-type(4) > div > '
                                           'div > div > img',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[4]/div[1]/div[1]/div[1]/img[1]',
                               'text': '',
                               'element_text': '',
                               'tag': 'img',
                               'attributes': {}},
        'bounding_box': {   'x': 43.73749923706055,
                            'y': 91.86250305175781,
                            'width': 140.5,
                            'height': 150},
        'page_url': 'https://www.flipkart.com/search?q=mouse+wireless&sid=6bo%2Ctia%2C8pp%2Cp0w&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&as-pos=1&as-type=RECENT&suggestionId=mouse+wireless%7CMouse&requestId=0adb2f9f-ebb4-4f20-bc7c-70ce8ec2ef5e&as-searchtext=mouse%20wireless',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:45.813Z',
        'delay_before_ms': 1240,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:46.931Z',
        'delay_before_ms': 1118,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': '3. EVM Classy Ambidextrous Opt...\n'
                                                  '4.1227 Ratings&25 Reviews\n'
                                                  '₹19667% off',
                               'placeholder': None,
                               'title': None,
                               'href': '/evm-classy-ambidextrous-optical-mouse-3600-dpi-6-button-rgb-led/p/itmbdcac8f6f77d0?pid=ACCGZTFTKYUZKJVY&marketplace=FLIPKART&ov_redirect=true',
                               'css_path': 'div#container > div > div:nth-of-type(3) > '
                                           'div:nth-of-type(2) > div > div:nth-of-type(4) > div > '
                                           'div:nth-of-type(2) > a',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]/div[1]/div[4]/div[1]/div[2]/a[1]',
                               'text': '3. EVM Classy Ambidextrous Opt...\n'
                                       '4.1227 Ratings&25 Reviews\n'
                                       '₹19667% off',
                               'element_text': '3. EVM Classy Ambidextrous Opt...\n'
                                               '4.1227 Ratings&25 Reviews\n'
                                               '₹19667% off',
                               'tag': 'a',
                               'attributes': {   'href': '/evm-classy-ambidextrous-optical-mouse-3600-dpi-6-button-rgb-led/p/itmbdcac8f6f77d0?pid=ACCGZTFTKYUZKJVY&marketplace=FLIPKART&ov_redirect=true'}},
        'bounding_box': {   'x': 219.9875030517578,
                            'y': 91.86250305175781,
                            'width': 286.88751220703125,
                            'height': 101},
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:48.766Z',
        'delay_before_ms': 1835,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'tab_open',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.flipkart.com/evm-classy-ambidextrous-optical-mouse-3600-dpi-6-button-rgb-led/p/itmbdcac8f6f77d0?pid=ACCGZTFTKYUZKJVY&marketplace=FLIPKART&ov_redirect=true',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:52.044Z',
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 720,
        'timestamp': '2026-08-20T07:29:52.965Z',
        'delay_before_ms': 921,
        'new_tab': None,
        'page_id': 2,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[15]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]',
                               'text': '',
                               'element_text': '',
                               'tag': 'div',
                               'attributes': {}},
        'bounding_box': {'x': 994, 'y': 667.7999877929688, 'width': 230, 'height': 44},
        'page_url': 'https://www.flipkart.com/evm-classy-ambidextrous-optical-mouse-3600-dpi-6-button-rgb-led/p/itmbdcac8f6f77d0?pid=ACCGZTFTKYUZKJVY&marketplace=FLIPKART&ov_redirect=true',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:29:54.029Z',
    ...
    {   'action_type': 'tab_close',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-20T07:30:02.331Z',
        'delay_before_ms': 8302,
        'new_tab': None,
        'page_id': 2,
        'from_page_id': None,
        'to_page_id': None,
...
SOURCE_NAME = "session_20260820_130002"
...
def _replay_scroll(page, dx, dy, scroll_y_after=None):
            ...
            try:
                ...
                if resolved_page is None:
                    ...
                    if action_type == "navigate":
                        ...
                        # wheel movement that was recorded, on the page as
                        # a whole. scroll_y_after (absolute recorded
                        # position) is passed through when present so the
                        # final position gets corrected for any drift;
                        # omitted on older recordings, which replay via
                        # delta alone exactly as before.
                        try:
                            _replay_scroll(
                                page,
