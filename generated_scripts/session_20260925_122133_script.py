"""
Auto-generated from recording: session_20260925_122133
Generated at: 2026-09-25T12:23:24.127377
Original recorded (production) URL: http://127.0.0.1:56837/phase4_product_card.html
...
Run directly with: python session_20260925_122133_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'navigate',
        ...
        'page_url': 'http://127.0.0.1:56837/phase4_product_card.html',
        'delta_x': None,
        'delta_y': None,
        ...
        'timestamp': '2026-09-25T06:51:33.665Z',
    ...
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#card-45954123',
                               'name': None,
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'NEW\n'
        ...
        'act_target': {   'id': '#card-45954123',
                          ...
                          'match_count': {'id': 1, 'text+tag': 0, 'css_path': 1, 'xpath': 1}},
        'state_target': None,
        'dom_context': {   'act_target_html_chain': [   '<a '
                                                        'href="/tshirts/monk-mode/monk-mode-men-striped-polo-collar-t-shirt/45954123/buy" '
                                                        'class="card" id="card-45954123">\n'
                                                        '      <span class="badge">NEW</span>\n'
                                                        '      <span class="badge">NEW</span>\n'
                                                        '      <span class="badge">NEW</span>\n'
                                                        '      <div>Monk Mode</div>\n'
                                                        '      <div class="overlay-sizes">Sizes: '
                                                        'XXL</div>\n'
                                                        '      <div class="price">Rs. 744 Rs. '
                                                        '1699(56% OFF)</div>\n'
                                                        '    </a>',
                                                        '<div class="grid">\n'
                                                        '    <a '
                                                        ...
                                                        '1699(56% OFF)</div>\n'
                                                        '    </a>\n'
                                                        '    <a href="/other/product/99999/buy" '
                                                        'class="card" id="card-99999">\n'
                                                        '      <span class="badge">NEW</span>\n'
                                                        '      <div>Some Other Shirt</div>\n'
                                                        '      <div class="overlay-sizes">Sizes: '
                                                        'M</div>\n'
                                                        ...
                                                        '  <script>\n'
                                                        '    '
                                                        "document.getElementById('card-45954123').addEventListener('click', "
                                                        'function (e) {\n'
                                                        '      e.preventDefault();\n'
                                                        '      document.title = '
                                                        "'CARD_CLICKED_45954123';\n"
                                                        '    });\n'
                                                        '    '
                                                        "document.getElementById('card-99999').addEventListener('click', "
                                                        'function (e) {\n'
                                                        '      e.preventDefault();\n'
                                                        '      document.title = '
                                                        "'CARD_CLICKED_99999';\n"
                                                        ...
                                                        '<html><head>\n'
                                                        '<meta charset="utf-8">\n'
                                                        '<title>Product Card Fixture</title>\n'
                                                        '<style>\n'
                                                        '  body { margin: 0; font-family: '
                                                        'sans-serif; padding: 20px; }\n'
                                                        '  .grid { display: flex; gap: 16px; }\n'
                                                        '  .card { display: inline-block; width: '
                                                        '260px; height: 340px; border: 1px solid '
                                                        '#ddd;\n'
                                                        '          padding: 10px; position: '
                                                        'relative; text-decoration: none; color: '
                                                        '#000; }\n'
                                                        '  .badge { display: block; color: red; '
                                                        'font-weight: bold; }\n'
                                                        '  .overlay-sizes { display: none; '
                                                        'background: #fafafa; padding: 4px; }\n'
                                                        '  .card:hover .overlay-sizes { display: '
                                                        'block; }\n'
                                                        '  .price { color: green; }\n'
                                                        '</style>\n'
                                                        '</head>\n'
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T06:51:33.775Z',
        'delay_before_ms': None,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        ...
        'match_mode': None,
        'name': None}]
PROD_URL = "http://127.0.0.1:56837/phase4_product_card.html"
SOURCE_NAME = "session_20260925_122133"
