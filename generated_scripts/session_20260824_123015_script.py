"""
Auto-generated from recording: session_20260824_123015
Generated at: 2026-08-24T12:30:15.898997
Original recorded (production) URL: https://www.google.com/?zx=1787554791992
...
Run directly with: python session_20260824_123015_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/table[1]/tbody[1]',
                               'text': '',
                               'element_text': '',
                               'tag': 'tbody',
                               'attributes': {}},
        'bounding_box': {'x': 6, 'y': 126, 'width': 388, 'height': 388},
        'page_url': 'https://www.google.com/recaptcha/enterprise/bframe?hl=en&v=xg_pWYS8-HRESiV6Rdg4aY_R&k=6LdLLIMbAAAAAIl-KLj9p1ePhM-4LCCDbjtJLqRO&bft=0dAFcWeA6zk3HvJxDQVoJD0gJKGfJNiAS34V3KUlKjn8P2pcnIQqgdDrtvvZ9-EtsusDmQLspqJnpDsrSdahYP8yJNLulHL3hBAA',
        'delta_x': None,
        'delta_y': None,
        ...
        'timestamp': '2026-08-24T07:00:01.437Z',
        'delay_before_ms': 0,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.google.com/sorry/index?continue=https://www.google.com/search%3Fq%3Dhello%26sca_esv%3Dc43d336a116f8bd5%26sxsrf%3DAPpeQntu0nOpuNAnPhNJtsnmTbsAaYP5tA%253A1787554791109%26source%3Dhp%26ei%3D5-uLauzNBOPgseMPndze6Q4%26iflsig%3DABILxe8AAAAAaov590h8LoNA5RFoyRz-TSEoR-Yk9kY4%26ved%3D0ahUKEwis3drC2LiWAxVjcGwGHR2uN-0Q4dUDCCE%26uact%3D5%26oq%3Dhello%26gs_lp%-ACAE%26sclient%3Dgws-wiz%26sei%3D6-uLao_kLaCrhvcPgIGqiQw&q=EgRqMzCuGOzXr9QGIjAoUTt85PAYsnfqzw9YP80AeopyxwRxECoejkkDTqeWTa7D6E8e1B-b1wh_XOpbmWIyAVJaAUM',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:01.645Z',
        'delay_before_ms': 208,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:01.886Z',
        'delay_before_ms': 241,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:02.767Z',
        'delay_before_ms': 881,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:03.957Z',
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               'name': None,
                               'role': 'button',
                               'aria_label': 'Show more AI Overview',
                               'accessible_name': 'Show more AI Overview',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'css_path': 'div#_-uuLaqPyAtTX5OUP9f2luAg_17 > div > div > '
                                           'div:nth-of-type(3) > div > div',
                               'xpath': '/html[1]/body[1]/div[3]/div[1]/div[13]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]',
                               'text': 'Show more',
                               'element_text': 'Show more',
                               'tag': 'div',
                               'attributes': {   'aria-label': 'Show more AI Overview',
                                                 'role': 'button'}},
        'bounding_box': {   'x': 81.38750457763672,
                            'y': 483,
                            'width': 1100.425048828125,
                            'height': 49.60000228881836},
        'page_url': 'https://www.google.com/search?q=hello&sca_esv=c43d336a116f8bd5&sxsrf=APpeQntu0nOpuNAnPhNJtsnmTbsAaYP5tA%3A1787554791109&source=hp&ei=5-uLauzNBOPgseMPndze6Q4&iflsig=ABILxe8AAAAAaov590h8LoNA5RFoyRz-TSEoR-Yk9kY4&ved=0ahUKEwis3drC2LiWAxVjcGwGHR2uN-0Q4dUDCCE&uact=5&oq=hello&gs_lp=-ACAE&sclient=gws-wiz&sei=6-uLao_kLaCrhvcPgIGqiQw',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:12.812Z',
        'delay_before_ms': 8855,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'tab_close',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-24T07:00:15.856Z',
        'delay_before_ms': 3044,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
        ...
        'to_url': None,
        'remaining_page_id': None}]
PROD_URL = "https://www.google.com/?zx=1787554791992"
SOURCE_NAME = "session_20260824_123015"
...
def run(qa_url, output_json_path=None, screenshot_dir=None, headless=True, product_name=None):
    ...
    # an explicit screenshot_dir (the dashboard's Run Test flow always
    # passes one - see execute_test in executor/run_execution.py) is
    # already a fresh, unique-per-run folder, used as-is. The fallback
    # here only kicks in when the script is run directly with no
    # screenshot_dir arg - without a per-run subfolder of its own, every
    # such run would write into the SAME shared "run_screenshots" folder
    # and different runs' same-numbered steps (e.g. two different
    # recordings both producing "001_click...png") would collide/
    # interleave with no way to tell which run a given file came from.
    if screenshot_dir:
        shot_dir = Path(screenshot_dir)
    else:
        run_id = f"{_slug(SOURCE_NAME) or 'run'}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
        shot_dir = Path(__file__).resolve().parent / "run_screenshots" / run_id
    ...
    with sync_playwright() as p:
        ...
        # milestone capture: the settled result of the very first page
        # load, before any recorded action has run - in addition to (not
        # instead of) every per-step screenshot below
        try:
            page.screenshot(path=str(shot_dir / "milestone_initial_load.png"))
        except Exception:
            pass
                ...
                if resolved_page is None:
                    ...
                    if action_type == "navigate":
                        ...
                        if ok and action_type in NAV_CAUSING_ACTIONS:
                            _settle(page)
                            # milestone capture: the settled result of a
                            # real page transition (e.g. reaching a login
                            # page, a successful-login redirect) - this is
                            # IN ADDITION to that same step's own per-step
                            # screenshot taken below, never a replacement
                            # for it
                            try:
                                page.screenshot(
                                    path=str(shot_dir / f"milestone_{_screenshot_name(i, step)}.png")
                                )
                            except Exception:
                                pass
