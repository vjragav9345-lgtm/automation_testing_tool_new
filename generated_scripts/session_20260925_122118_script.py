"""
Auto-generated from recording: session_20260925_122118
Generated at: 2026-09-25T12:21:22.408235
Original recorded (production) URL: http://127.0.0.1:56824/phase4_hover_menu.html
...
Run directly with: python session_20260925_122118_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'navigate',
        ...
        'page_url': 'http://127.0.0.1:56824/phase4_hover_menu.html',
        'delta_x': None,
        'delta_y': None,
        ...
        'timestamp': '2026-09-25T06:51:18.140Z',
    ...
    {   'action_type': 'hover',
        'value': None,
        'locator_profile': {   'id': '#men-trigger',
                               'name': None,
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'MEN\nCasual Shirts\nFormal Shirts',
                               ...
                               'href': None,
                               'product_id': None,
                               'css_path': 'div#men-trigger',
                               'xpath': "//*[@id='men-trigger']",
                               'text': 'MEN\nCasual Shirts\nFormal Shirts',
                               'element_text': 'MEN\nCasual Shirts\nFormal Shirts',
                               'tag': 'div',
                               'attributes': {},
        ...
        'bounding_box': {'x': 16, 'y': 16, 'width': 51.5625, 'height': 34},
        'click_strategy': None,
        'wait_for_stable_state': None,
        'wait_for_stable_state_timeout_ms': None,
        'click_selector': None,
        ...
        'hover_chain': None,
        'expect': {   'type': 'reveal',
                      'revealed_locator_profile': {   'id': '#casual-shirts-link',
                                                      'name': None,
                                                      'role': None,
                                                      'aria_label': None,
                                                      ...
                                                      'product_id': None,
                                                      'css_path': 'a#casual-shirts-link',
                                                      'xpath': "//*[@id='casual-shirts-link']",
                                                      'text': 'Casual Shirts',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T06:51:20.089Z',
        'delay_before_ms': None,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#casual-shirts-link',
                               'name': None,
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'Casual Shirts',
                               ...
                               'cross_boundary': False,
                               'icon_class_hint': None,
                               'match_count': {'id': 1, 'text+tag': 1, 'css_path': 1, 'xpath': 1}},
        'bounding_box': {'x': 27, 'y': 61, 'width': 160, 'height': 26},
        ...
        'caused_by_timestamp': None,
        'dom_snapshot_path': None,
        'act_target': {   'id': '#casual-shirts-link',
                          'name': None,
                          'role': None,
                          'aria_label': None,
                          'accessible_name': 'Casual Shirts',
                          ...
                          'match_count': {'id': 1, 'text+tag': 1, 'css_path': 1, 'xpath': 1}},
        'state_target': None,
        'dom_context': {   'act_target_html_chain': [   '<a href="/men-casual-shirts" '
                                                        'id="casual-shirts-link">Casual Shirts</a>',
                                                        '<div class="submenu" id="men-submenu">\n'
                                                        '        <a href="/men-casual-shirts" '
                                                        'id="casual-shirts-link">Casual '
                                                        'Shirts</a>\n'
                                                        '        <a href="/men-formal-shirts" '
                                                        'id="formal-shirts-link">Formal '
                                                        'Shirts</a>\n'
                                                        '      </div>',
                                                        '<div class="nav-item" '
                                                        'id="men-trigger">MEN\n'
                                                        ...
                                                        '    </div>\n'
                                                        '    <div class="nav-item" '
                                                        'id="women-trigger">WOMEN\n'
                                                        '      <div class="submenu" '
                                                        'id="women-submenu">\n'
                                                        '        <a href="/women-dresses" '
                                                        'id="dresses-link">Dresses</a>\n'
                                                        '      </div>\n'
                                                        '    </div>\n'
                                                        '    <a href="/about" id="ordinary-link" '
                                                        'style="color:#fff;">About (ordinary, '
                                                        'always visible)</a>\n'
                                                        '  </div>',
                                                        '<body>\n'
                                                        '  <div class="navbar">\n'
                                                        ...
                                                        '  </div>\n'
                                                        '  <div class="filler"><p '
                                                        'style="padding:20px;">filler content so a '
                                                        'scroll-search has somewhere to go if it '
                                                        'mistakenly runs</p></div>\n'
                                                        '  <footer id="footer">Footer content - '
                                                        'never the real target</footer>\n'
                                                        '  <script>\n'
                                                        '    '
                                                        "document.getElementById('casual-shirts-link').addEventListener('click', "
                                                        'function (e) {\n'
                                                        '      e.preventDefault();\n'
                                                        '      document.title = '
                                                        "'CASUAL_SHIRTS_CLICKED';\n"
                                                        '    });\n'
                                                        '    '
                                                        "document.getElementById('ordinary-link').addEventListener('click', "
                                                        'function (e) {\n'
                                                        '      e.preventDefault();\n'
                                                        '      document.title = '
                                                        "'ORDINARY_LINK_CLICKED';\n"
                                                        '    });\n'
                                                        '  </script>\n'
                                                        '\n'
                                                        '\n'
                                                        ...
                                                        '<html><head>\n'
                                                        '<meta charset="utf-8">\n'
                                                        '<title>Hover Menu Fixture</title>\n'
                                                        '<style>\n'
                                                        '  body { margin: 0; font-family: '
                                                        'sans-serif; }\n'
                                                        '  .navbar { display: flex; gap: 20px; '
                                                        'padding: 16px; background: #222; }\n'
                                                        '  .nav-item { position: relative; color: '
                                                        '#fff; cursor: pointer; padding: 8px; }\n'
                                                        '  .submenu { display: none; position: '
                                                        'absolute; top: 100%; left: 0; background: '
                                                        '#fff;\n'
                                                        '             border: 1px solid #ccc; '
                                                        'padding: 10px; min-width: 160px; z-index: '
                                                        '10; }\n'
                                                        '  .nav-item:hover .submenu { display: '
                                                        'block; }\n'
                                                        '  .submenu a { display: block; color: '
                                                        '#000; text-decoration: none; padding: 4px '
                                                        '0; }\n'
                                                        '  .filler { height: 3000px; background: '
                                                        'linear-gradient(#eee, #ddd); }\n'
                                                        '  footer { height: 200px; background: '
                                                        '#333; color: #fff; text-align: center; '
                                                        'line-height: 200px; }\n'
                                                        '</style>\n'
                                                        '</head>\n'
                                                        '<body>\n'
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T06:51:20.090Z',
        'delay_before_ms': None,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        ...
        'match_mode': None,
        'name': None}]
PROD_URL = "http://127.0.0.1:56824/phase4_hover_menu.html"
SOURCE_NAME = "session_20260925_122118"
