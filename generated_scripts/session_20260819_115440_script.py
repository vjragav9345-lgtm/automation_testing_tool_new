"""
Auto-generated from recording: session_20260819_115440
Generated at: 2026-08-19T11:54:40.748200
...
Run directly with: python session_20260819_115440_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'fill',
        'value': 'iphone',
        'locator_profile': {   'id': '#twotabsearchtextbox',
                               'name': 'field-keywords',
                               'role': 'searchbox',
                               'aria_label': 'Search Amazon',
                               'accessible_name': 'Search Amazon',
                               'placeholder': 'Search Amazon',
                               'title': None,
                               'href': None,
                               'css_path': 'input#twotabsearchtextbox',
                               ...
                               'attributes': {   'type': 'text',
                                                 ...
                                                 'role': 'searchbox'}},
        'bounding_box': {   'x': 276.2875061035156,
                            'y': 10.800000190734863,
                            'width': 531.9625244140625,
                            'height': 38},
        ...
        'timestamp': '2026-08-19T06:23:23.018Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.amazon.com/s?k=iphone+17&crid=11N9LKEFT8LH6&sprefix=iphone%2Caps%2C333&ref=nb_sb_ss_p13n-expert-pd-ops-ranker_ci_hl-bn-left_4_6',
        'delta_x': 0,
        'delta_y': 215,
        'scroll_y_before': 6.400000095367432,
        'scroll_y_after': 172,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:26.397Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:23:28.567Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_y': 829,
        'scroll_y_before': 172,
        'scroll_y_after': 835.2000122070312,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:28.760Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_y': 1950,
        'scroll_y_before': 848,
        'scroll_y_after': 2395.199951171875,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:31.865Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 552,
        'scroll_y_before': 2395.199951171875,
        'scroll_y_after': 2836.800048828125,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:32.714Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': -160,
        'scroll_y_before': 2836.800048828125,
        'scroll_y_after': 2708.800048828125,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:33.854Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 230,
        'scroll_y_before': 2708.800048828125,
        'scroll_y_after': 2892.800048828125,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:34.793Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 1504,
        'scroll_y_before': 2892.800048828125,
        'scroll_y_after': 4096,
        'viewport_height': 720,
        'document_height': 6275,
        'timestamp': '2026-08-19T06:23:36.944Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': -6456,
        'scroll_y_before': 4102.39990234375,
        'scroll_y_after': 0,
        'viewport_height': 720,
        'document_height': 6523,
        'timestamp': '2026-08-19T06:23:41.527Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'placeholder': None,
                               'title': None,
                               'href': '/Apple-Version-Unlocked-Renewed-Premium/dp/B0G45X8NCK/ref=sr_1_1?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone+17&qid=1787120604&sprefix=iphone%2Caps%2C333&sr=8-1',
                               'css_path': 'div#242d0842-6824-446d-a94d-ab1e860e0d9d > div > div > '
                                           'span > div > div > div > div > div > '
                                           'div:nth-of-type(2) > div > span > a',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/span[1]/a[1]',
                               'text': '',
                               'element_text': '',
                               'tag': 'a',
                               'attributes': {   'href': '/Apple-Version-Unlocked-Renewed-Premium/dp/B0G45X8NCK/ref=sr_1_1?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone+17&qid=1787120604&sprefix=iphone%2Caps%2C333&sr=8-1'}},
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:23:42.214Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.amazon.com/Apple-Version-Unlocked-Renewed-Premium/dp/B0G45X8NCK/ref=sr_1_1?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone%2B17&qid=1787120604&sprefix=iphone%2Caps%2C333&sr=8-1&th=1',
        'delta_x': 0,
        'delta_y': 155,
        'scroll_y_before': 0,
        'scroll_y_after': 108.80000305175781,
        'viewport_height': 720,
        'document_height': 11002,
        'timestamp': '2026-08-19T06:23:44.997Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'scroll_y_after': 360,
        'viewport_height': 720,
        'document_height': 11027,
        'timestamp': '2026-08-19T06:23:45.570Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'viewport_height': 720,
        'document_height': 11032,
        'timestamp': '2026-08-19T06:23:46.038Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 161,
        'scroll_y_before': 466.3999938964844,
        'scroll_y_after': 535.2000122070312,
        'viewport_height': 720,
        'document_height': 11032,
        'timestamp': '2026-08-19T06:23:46.542Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:23:50.435Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': -1980,
        'scroll_y_before': 543.2000122070312,
        'scroll_y_after': 0,
        'viewport_height': 720,
        'document_height': 12058,
        'timestamp': '2026-08-19T06:23:52.530Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': 2890,
        'scroll_y_before': 3.200000047683716,
        'scroll_y_after': 2312,
        'viewport_height': 720,
        'document_height': 5798,
        'timestamp': '2026-08-19T06:23:58.312Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:23:58.973Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'title': None,
                               'href': None,
                               'css_path': 'span#a-autoid-2 > span > input',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[11]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[4]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/form[1]/div[1]/div[1]/span[1]/div[1]/div[1]/span[1]/span[1]/input[1]',
                               'text': '',
                               'element_text': '',
                               'tag': 'input',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:23:59.347Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'placeholder': None,
                               'title': None,
                               'href': '/Samsung-Unlocked-Smartphone-Charging-Warranty/dp/B0G4SW3XXP/ref=sr_1_10?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone+17&qid=1787120635&sprefix=iphone%2Caps%2C333&sr=8-10',
                               'css_path': 'div#1f963ec2-ea78-4d81-a828-29d90f5189de > div > div > '
                                           'span > div > div > div > div > div > '
                                           'div:nth-of-type(2) > div > span > a',
                               'xpath': '/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[11]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/span[1]/a[1]',
                               'text': '',
                               'element_text': '',
                               'tag': 'a',
                               'attributes': {   'href': '/Samsung-Unlocked-Smartphone-Charging-Warranty/dp/B0G4SW3XXP/ref=sr_1_10?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone+17&qid=1787120635&sprefix=iphone%2Caps%2C333&sr=8-10'}},
        'bounding_box': {   'x': 300.8999938964844,
                            'y': 89.4000015258789,
                            'width': 256.5,
                            'height': 218},
        'page_url': 'https://www.amazon.com/s?k=iphone+17&crid=11N9LKEFT8LH6&sprefix=iphone%2Caps%2C333&ref=nb_sb_ss_p13n-expert-pd-ops-ranker_ci_hl-bn-left_4_6',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:01.554Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#add-to-cart-button',
                               ...
                               'href': None,
                               'css_path': 'input#add-to-cart-button',
                               'xpath': "//*[@id='add-to-cart-button']",
                               'text': 'Add to cart',
                               'element_text': 'Add to cart',
                               'tag': 'input',
                               'attributes': {   'name': 'submit.add-to-cart',
                                                 'title': 'Add to Shopping Cart',
                                                 'type': 'submit'}},
        'bounding_box': {   'x': 890.7999877929688,
                            'y': 510,
                            'width': 204.8000030517578,
                            'height': 30},
        'page_url': 'https://www.amazon.com/Samsung-Unlocked-Smartphone-Charging-Warranty/dp/B0G4SW3XXP/ref=sr_1_10?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone%2B17&qid=1787120635&sprefix=iphone%2Caps%2C333&sr=8-10&th=1',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:04.486Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'submit',
        'value': None,
        'locator_profile': {   'id': '#addToCart',
                               'name': None,
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'INR127,942.57\n'
                                                  'INR127,942\n'
                                                  '.\n'
                                                  '57\n'
                                                  'INR\xa053,663.93 Shipping & Import Charges to '
                                                  'India D',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'css_path': 'form#addToCart',
                               'xpath': "//*[@id='addToCart']",
                               'text': 'INR127,942.57\n'
                                       'INR127,942\n'
                                       '.\n'
                                       '57\n'
                                       'INR\xa053,663.93 Shipping & Import Charges to India D',
                               'element_text': 'INR127,942.57\n'
                                               'INR127,942\n'
                                               '.\n'
                                               '57\n'
                                               'INR\xa053,663.93 Shipping & Import Charges to '
                               ...
                               'tag': 'form',
                               'attributes': {}},
        'bounding_box': {   'x': 871.2000122070312,
                            'y': 236,
                            'width': 244,
                            'height': 573.7999877929688},
        'page_url': 'https://www.amazon.com/Samsung-Unlocked-Smartphone-Charging-Warranty/dp/B0G4SW3XXP/ref=sr_1_10?crid=11N9LKEFT8LH6&dib=eyJ2IjoiMSJ9.qk7mtoixPkqn8jwI-BLukTOS34a-M3Pd0s48aNP-cB5bjw6CDhZRrhgP_bpX3LESRl1v7NhPc6dpjI00AUqnFHU9AobuyBULl7E829aDTb_RB7zR6-KAymNKY6yVkEEL4EeSwxfrgRcI_T3Fv3N6plRKjBNAOFc4WfM1IBa5C1GewJs_2mEePP1p7LV5VLZgLxLPBWWA_v7KXak9spVkLyi0LCJ-be_wMchTPBFr2jg.AoOnnUrOQaR0bFapXjAro1VH5OB2G1S4KCH9xTEtGmA&dib_tag=se&keywords=iphone%2B17&qid=1787120635&sprefix=iphone%2Caps%2C333&sr=8-10&th=1',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:04.496Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': '#nav-cart',
                               'name': None,
                               'role': None,
                               'aria_label': '2 items in cart',
                               'accessible_name': '2 items in cart',
                               'placeholder': None,
                               'title': None,
        ...
        'bounding_box': {'x': 1038.2000732421875, 'y': 5, 'width': 84, 'height': 50},
        'page_url': 'https://www.amazon.com/cart/smart-wagon?newItems=3efb3d11-aa23-4374-b872-31d19559ec5e,2&ref_=sw_refresh',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:07.263Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               'name': None,
                               'role': None,
                               'aria_label': 'Decrease quantity by one, Quantity is 2, Samsung '
                                             'Galaxy S26 Ultra, Unlocked Android Smartphone, '
                                             '512GB, Black | Privacy Display, Galaxy AI, AI '
                                             'Camera, Super Fast Charging 3.0, Durable Battery, '
                                             '2026, US 1 Year Warranty',
                               'accessible_name': 'Decrease quantity by one, Quantity is 2, '
                                                  'Samsung Galaxy S26 Ultra, Unlocked Android '
                                                  'Smartphone, 512GB, Black | Privacy Display, '
                                                  'Galaxy AI, AI Camera, Super Fast Charging 3.0, '
                                                  'Durable Battery, 2026, US 1 Year Warranty',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'css_path': 'div#sc-active-3efb3d11-aa23-4374-b872-31d19559ec5e > '
                               ...
                               'element_text': '',
                               'tag': 'button',
                               'attributes': {   'aria-label': 'Decrease quantity by one, Quantity '
                                                               'is 2, Samsung Galaxy S26 Ultra, '
                                                               'Unlocked Android Smartphone, '
                                                               '512GB, Black | Privacy Display, '
                                                               'Galaxy AI, AI Camera, Super Fast '
                                                               'Charging 3.0, Durable Battery, '
                                                               '2026, US 1 Year Warranty'}},
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:11.157Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:12.251Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               'name': None,
                               'role': None,
                               'aria_label': 'Delete Samsung Galaxy S26 Ultra, Unlocked Android '
                                             'Smartphone, 512GB, Black | Privacy Display, Galaxy '
                                             'AI, AI Camera, Super Fast Charging 3.0, Durable '
                                             'Battery, 2026, US 1 Year Warranty',
                               'accessible_name': 'Delete Samsung Galaxy S26 Ultra, Unlocked '
                                                  'Android Smartphone, 512GB, Black | Privacy '
                                                  'Display, Galaxy AI, AI Camera, Super Fast '
                                                  'Charging 3.0, Durable Battery, 2026, US 1 Year '
                                                  'Warranty',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               ...
                               'element_text': '',
                               'tag': 'button',
                               'attributes': {   'aria-label': 'Delete Samsung Galaxy S26 Ultra, '
                                                               'Unlocked Android Smartphone, '
                                                               '512GB, Black | Privacy Display, '
                                                               'Galaxy AI, AI Camera, Super Fast '
                                                               'Charging 3.0, Durable Battery, '
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:12.586Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'scroll_y_after': 0,
        'viewport_height': 720,
        'document_height': 2912,
        'timestamp': '2026-08-19T06:24:14.827Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'scroll',
        ...
        'delta_x': 0,
        'delta_y': -3574,
        'scroll_y_before': 2348,
        'scroll_y_after': 0,
        'viewport_height': 720,
        'document_height': 5858,
        'timestamp': '2026-08-19T06:24:26.827Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:27.551Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'id': '#nav-orders',
                               'name': None,
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'Returns\n& Orders',
                               'placeholder': None,
                               'title': None,
                               'href': '/gp/css/order-history?ref_=nav_orders_first',
                               'css_path': 'a#nav-orders',
                               'xpath': "//*[@id='nav-orders']",
                               'text': 'Returns\n& Orders',
                               'element_text': 'Returns\n& Orders',
                               'tag': 'a',
                               'attributes': {   'href': '/gp/css/order-history?ref_=nav_orders_first'}},
        'bounding_box': {'x': 1089.6500244140625, 'y': 5, 'width': 76.55000305175781, 'height': 50},
        'page_url': 'https://www.amazon.com/s?k=iphone+17&crid=11N9LKEFT8LH6&sprefix=iphone%2Caps%2C333&ref=nb_sb_ss_p13n-expert-pd-ops-ranker_ci_hl-bn-left_4_6',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:36.286Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'locator_profile': {},
        'bounding_box': {},
        'page_url': 'https://www.amazon.com/ap/signin?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fwww.amazon.com%2Fyour-orders%2Forders%3Fref_%3Dnav_orders_first&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=amzn_retail_yourorders_us&openid.mode=checkid_setup&language=en_US&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-08-19T06:24:40.692Z',
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
...
SOURCE_NAME = "session_20260819_115440"
...
def resolve_and_act(page, step):
    ...
    # 5-8: other attributes that are usually stable and human-meaningful.
    # aria-label/title are tried both as raw attributes (5-6, matches any
    # element) and, for aria-label, the dedicated locator_profile.aria_label
    # field is equivalent - attrs already carries it when present.
    for attr in ("name", "aria-label", "placeholder", "title"):
        if el is None:
            el = _by_attr(page, attr, attrs.get(attr))
            if el is not None:
                strategy = attr

    # 9: accessibility role + accessible name - accessible_name (computed
    # the same way a screen reader would: aria-label, aria-labelledby, alt,
    # placeholder, then visible text) is a better discriminator than raw
    # visible text alone, but falls back to it for older recordings that
    # predate this field
    if el is None and (attrs.get("role") or lp.get("role")):
        try:
            role = attrs.get("role") or lp.get("role")
    ...
    # 10: stable href - links are common navigation targets and a full
    # href is normally far more stable across a dynamic page's re-renders
    # than a position-dependent CSS path ever is
    if el is None and lp.get("href"):
        try:
            safe = lp["href"].replace('"', '\"')
            c = page.locator(f'a[href="{safe}"]')
            if c.count() > 0:
                el, strategy = c.first, "href"
        except Exception:
            pass

    # 11: visible text + tag - promoted above css_path/xpath because a
    # positional selector (nth-of-type chains especially) silently points
    # at the wrong element the moment a dynamic page's layout/ordering
    # shifts even slightly, while matching on an element's own stable
    ...
    # 12: css path / xpath - kept as a fallback rather than removed: still
    # useful when an element genuinely has no id/role/href/stable text
    # (a bare styled div/span acting as a custom control), just no longer
    # preferred over the more resilient signals above
...
def _resolve_target_page(pages, target_page_id, anchor_page, fallback_url=None, wait_seconds=5):
    ...
    while time.monotonic() < deadline:
        if target_page_id in pages:
            return pages[target_page_id], None
        anchor_page.wait_for_timeout(100)
    ...
    try:
        new_page = anchor_page.context.new_page()
