"""
Auto-generated from recording: session_20260925_102127
Generated at: 2026-09-25T12:16:17.201806
...
Run directly with: python session_20260925_102127_script.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'navigate',
        ...
        'timestamp': '2026-09-25T04:51:27.605Z',
        'delay_before_ms': 0,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': None,
                               'aria_label': None,
                               'accessible_name': 'Speakers',
                               'placeholder': None,
                               'title': None,
                               'href': '/speakers',
                               'product_id': None,
                               'css_path': 'header#desktop-header-cnt > div:nth-of-type(2) > nav > '
                                           'div > div > div > div > div > div > li:nth-of-type(4) '
                                           '> ul > li:nth-of-type(14) > a',
                               'xpath': "(//li[contains(., 'Speakers')])[2]//a",
                               'text': 'Speakers',
                               'element_text': 'Speakers',
                               'tag': 'a',
                               'attributes': {'href': '/speakers'},
                               'cross_boundary': False,
                               'icon_class_hint': None},
        'bounding_box': {'x': 749.6000366210938, 'y': 428, 'width': 191, 'height': 23},
        ...
        'act_target': {   'id': None,
                          ...
                          'href': '/speakers',
                          'product_id': None,
                          'css_path': 'header#desktop-header-cnt > div:nth-of-type(2) > nav > div '
                                      '> div > div > div > div > div > li:nth-of-type(4) > ul > '
                                      'li:nth-of-type(14) > a',
                          'xpath': "(//li[contains(., 'Speakers')])[2]//a",
                          'text': 'Speakers',
                          'element_text': 'Speakers',
                          ...
                          'icon_class_hint': None},
        'state_target': None,
        'dom_context': {   'act_target_html_chain': [   '<a href="/speakers" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="144">Speakers</a>',
                                                        '<li data-reactid="143"><a '
                                                        'href="/speakers" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="144">Speakers</a></li>',
                                                        ...
                                                        'data-reactid="117">Sports &amp; Active '
                                                        'Wear</a></li><li data-reactid="118"><a '
                                                        'href="/men-sports-shoes" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="119">Sports '
                                                        'Shoes</a></li><li data-reactid="120"><a '
                                                        'href="/men-sports-sandals" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="121">Sports '
                                                        'Sandals</a></li><li data-reactid="122"><a '
                                                        'href="/men-sports-wear-tshirts" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="123">Active '
                                                        'T-Shirts</a></li><li '
                                                        'data-reactid="124"><a '
                                                        'href="/men-trackpants-shorts" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="125">Track Pants &amp; '
                                                        'Shorts</a></li><li data-reactid="126"><a '
                                                        'href="/men-tracksuits" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="127">Tracksuits</a></li><li '
                                                        'data-reactid="128"><a '
                                                        'href="/men-sports-jackets" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="129">Jackets &amp; '
                                                        'Sweatshirts</a></li><li '
                                                        'data-reactid="130"><a '
                                                        ...
                                                        'class="desktop-categoryLink" '
                                                        'data-rea...[truncated]',
                                                        '<li class="desktop-evenColumnContent '
                                                        'desktop-oddColumnContent" '
                                                        'data-reactid="114"><ul '
                                                        'class="desktop-navBlock" '
                                                        'data-reactid="115"><li '
                                                        'data-reactid="116"><a '
                                                        'href="/men-sports-wear" '
                                                        'style="color:#ee5f73;" '
                                                        ...
                                                        'data-reactid="129">Jackets &amp; '
                                                        'Sweatshirts</a></li><li '
                                                        'data-reactid="130"><a hr...[truncated]',
                                                        '<div class="desktop-categoryContainer" '
                                                        'data-index="0" data-group="men" '
                                                        'data-color="#ee5f73" '
                                                        'data-reactid="25"><li '
                                                        'class="desktop-oddColumnContent" '
                                                        'data-reactid="26"><ul '
                                                        'class="desktop-navBlock" '
                                                        'data-reactid="27"><li '
                                                        'data-reactid="28"><a href="/men-topwear" '
                                                        'style="color:#ee5f73;" '
                                                        'class="desktop-categoryName" '
                                                        'data-reactid="29">Topwear</a></li><li '
                                                        'data-reactid="30"><a href="/men-tshirts" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="31">T-Shirts</a></li><li '
                                                        'data-reactid="32"><a '
                                                        'href="/men-casual-shirts" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="33">Casual '
                                                        'Shirts</a></li><li data-reactid="34"><a '
                                                        'href="/men-formal-shirts" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="35">Formal '
                                                        'Shirts</a></li><li data-reactid="36"><a '
                                                        'href="/men-sweatshirts" style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="37">Sweatshirts</a></li><li '
                                                        'data-reactid="38"><a href="/men-sweaters" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="39">Sweaters</a></li><li '
                                                        'data-reactid="40"><a href="/men-jackets" '
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="41">Jackets</a></li><li '
                                                        'data-reactid="42"><a href="/men-blazers" '
                                                        'sty...[truncated]',
                                                        ...
                                                        'style="color:;" '
                                                        'class="desktop-categoryLink" '
                                                        'data-reactid="41">Jackets</a></...[truncated]',
                                                        '<div class="desktop-backdropStyle" '
                                                        'data-reactid="23"><div '
                                                        'class="desktop-paneContent" '
                                                        'data-reactid="24"><div '
                                                        'class="desktop-categoryContainer" '
                                                        'data-index="0" data-group="men" '
                                                        'data-color="#ee5f73" '
                                                        ...
                                                        'data-reactid="39">Sweaters</a></li><li '
                                                        'data-reactid="40"><a href="/men-jackets" '
                                                        'style="color:;" class="...[truncated]'],
                           'act_target_style': {   'display': 'block',
                                                   'visibility': 'visible',
                                                   'opacity': '1'},
                           'state_target_html_chain': None,
                           'state_target_style': None},
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:27.725Z',
        'delay_before_ms': 120,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'confirmation_timeout_ms': None,
        'verification_timeout_ms': None,
        'page_url': 'https://www.myntra.com/speakers',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        ...
        'hover_chain': None,
        'expect': None,
        'caused_by_timestamp': '2026-09-25T04:51:27.725Z',
        'dom_snapshot_path': 'storage\\snapshots\\60cb381ca86341f389cf8e869d033867\\2026-09-25T04-51-29-099Z.html',
        'act_target': None,
        'state_target': None,
        'dom_context': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:29.099Z',
    ...
    {   'action_type': 'check',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': 'checkbox',
                               'aria_label': None,
                               'accessible_name': 'MZ(176)',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'product_id': None,
                               'css_path': 'div#mountRoot > div > main > div:nth-of-type(3) > div '
                                           '> section > div > div:nth-of-type(3) > ul > li > label',
                               'xpath': "//label[normalize-space(text())='MZ']",
                               'text': 'MZ(176)',
                               'element_text': 'MZ(176)',
                               'tag': 'label',
                               'attributes': {},
                               'cross_boundary': False,
                               'icon_class_hint': None},
        'bounding_box': {'x': 25, 'y': 398, 'width': 214.8874969482422, 'height': 17},
        'click_strategy': 'standard',
        'wait_for_stable_state': None,
        'wait_for_stable_state_timeout_ms': None,
        'click_selector': None,
        ...
        'act_target': {   'id': None,
                          ...
                          'cross_boundary': False,
                          'icon_class_hint': None},
        'state_target': {   'locator_profile': {   'id': None,
                                                   'name': None,
                                                   'role': 'checkbox',
                                                   'aria_label': None,
                                                   'accessible_name': 'MZ(176)',
                                                   ...
                                                   'href': None,
                                                   'product_id': None,
                                                   'css_path': 'div#mountRoot > div > main > '
                                                               'div:nth-of-type(3) > div > section '
                                                               '> div > div:nth-of-type(3) > ul > '
                                                               'li > label > input',
                                                   'xpath': "//label[normalize-space(text())='MZ']/input",
                                                   'text': 'MZ(176)',
                                                   'element_text': 'MZ',
                                                   'tag': 'input',
                                                   ...
                                                   'icon_class_hint': None},
                            'checked': True},
        'dom_context': {   'act_target_html_chain': [   '<label class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="MZ"><!-- '
                                                        'react-text: 66 -->MZ<!-- /react-text '
                                                        '--><span class="brand-num"><!-- '
                                                        'react-text: 68 -->(<!-- /react-text '
                                                        '--><!-- react-text: 69 -->176<!-- '
                                                        '/react-text --><!-- react-text: 70 '
                                                        '-->)<!-- /react-text --></span><div '
                                                        'class="common-checkboxIndicator"></div></label>',
                                                        '<li><label class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="MZ"><!-- '
                                                        'react-text: 66 -->MZ<!-- /react-text '
                                                        '--><span class="brand-num"><!-- '
                                                        ...
                                                        '/react-text --><!-- react-text: 70 '
                                                        '-->)<!-- /react-text --></span><div '
                                                        'class="common-checkboxIndicator"></div></label></li>',
                                                        '<ul class="brand-list"><li><label '
                                                        'class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="MZ"><!-- '
                                                        'react-text: 66 -->MZ<!-- /react-text '
                                                        '--><span class="brand-num"><!-- '
                                                        ...
                                                        '/react-text --><!-- react-text: 70 '
                                                        '-->)<!-- /react-text --></span><div '
                                                        'class="common-checkboxIndicator"></div></label></li><li><label '
                                                        'class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="boAt"><!-- '
                                                        'react-text: 75 -->boAt<!-- /react-text '
                                                        '--><span class="brand-num"><!-- '
                                                        'react-text: 77 -->(<!-- /react-text '
                                                        '--><!-- react-text: 78 -->41<!-- '
                                                        '/react-text --><!-- react-text: 79 '
                                                        '-->)<!-- /react-text '
                                                        '--></span><di...[truncated]',
                                                        '<div class="vertical-filters-filters '
                                                        'brand-container"><span '
                                                        'class="vertical-filters-header">Brand</span><div '
                                                        'class="filter-search-filterSearchBox"><input '
                                                        'type="text" class="filter-search-inputBox '
                                                        'filter-search-hidden" placeholder="Search '
                                                        'for Brand"><span class="myntraweb-sprite '
                                                        'filter-search-iconSearch '
                                                        'sprites-search"></span></div><ul '
                                                        'class="brand-list"><li><label '
                                                        'class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="MZ"><!-- '
                                                        'react-text: 66 -->MZ<!-- /react-text '
                                                        ...
                                                        '/react-text --><!-- react-text: 70 '
                                                        '-->)<!-- /react-text --></span><div '
                                                        'class="common-checkboxIndicator">...[truncated]',
                                                        '<div '
                                                        'class="condition-render-verticalFilters '
                                                        'condition-render-boundary-top"><div '
                                                        'class="vertical-filters-filters '
                                                        'header-container"><span '
                                                        'class="header-title">FILTERS</span></div><div '
                                                        'class="vertical-filters-filters"><ul '
                                                        'class="gender-list"><li><label '
                                                        'class="common-customRadio '
                                                        'gender-label"><input type="radio" '
                                                        'value="men,men women"><!-- react-text: 40 '
                                                        '-->Men<!-- /react-text --><div '
                                                        'class="common-radioIndicator"></div></label></li><li><label '
                                                        'class="common-customRadio '
                                                        'gender-label"><input type="radio" '
                                                        'value="women,men women"><!-- react-text: '
                                                        '45 -->Women<!-- /react-text --><div '
                                                        'class="common-radioIndicator"></div></label></li><li><label '
                                                        'class="common-customRadio '
                                                        'gender-label"><input type="radio" '
                                                        'v...[truncated]',
                                                        ...
                                                        'class="common-radioIndicator"></div></label></li><li><label '
                                                        'class="common-customRadio '
                                                        'gender-label"><input type=...[truncated]',
                                                        '<div class="search-leftContainer '
                                                        'column-base" style="-webkit-box-flex: 1; '
                                                        'flex: 1 1 0%;"><section><div '
                                                        'class="condition-render-verticalFilters '
                                                        'condition-render-boundary-top"><div '
                                                        'class="vertical-filters-filters '
                                                        'header-container"><span '
                                                        ...
                                                        'value="women,men women"><!-- react-text: '
                                                        '45 -->Women<!-- /react-text --><div '
                                                        'class="common-radioIndi...[truncated]'],
                           'act_target_style': {   'display': 'block',
                                                   'visibility': 'visible',
                                                   'opacity': '1'},
                           'state_target_html_chain': [   '<input type="checkbox" value="MZ">',
                                                          '<label class="vertical-filters-label '
                                                          'common-customCheckbox"><input '
                                                          'type="checkbox" value="MZ"><!-- '
                                                          'react-text: 66 -->MZ<!-- /react-text '
                                                          '--><span class="brand-num"><!-- '
                                                          ...
                                                          'class="filter-search-filterSearchBox"><input '
                                                          'type="text" '
                                                          'class="filter-search-inputBox '
                                                          'filter-search-hidden" '
                                                          'placeholder="Search for Brand"><span '
                                                          'class="myntraweb-sprite '
                                                          'filter-search-iconSearch '
                                                          'sprites-search"></span></div><ul '
                                                          'class="brand-list"><li><label '
                                                          'class="vertical-filters-label '
                                                          ...
                                                          'class="common-customRadio '
                                                          'gender-label"><input type="radio" '
                                                          'value="men,men women"><!-- react-text: '
                                                          '40 -->Men<!-- /react-text --><div '
                                                          'class="common-radioIndicator"></div></label></li><li><label '
                                                          'class="common-customRadi...[truncated]',
                                                          '<section><div '
                                                          'class="condition-render-verticalFilters '
                                                          'condition-render-boundary-top"><div '
                                                          'class="vertical-filters-filters '
                                                          ...
                                                          '40 -->Men<!-- /react-text --><div '
                                                          'class="common-radioIndicator"></div></label></li><li><label '
                                                          'class="common-c...[truncated]'],
                           'state_target_style': {   'display': 'inline-block',
                                                     'visibility': 'hidden',
                                                     'opacity': '1'}},
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:33.074Z',
        'delay_before_ms': 3975,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'confirmation_timeout_ms': None,
        'verification_timeout_ms': None,
        'page_url': 'https://www.myntra.com/speakers?f=Brand%3AMZ',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        ...
        'expect': None,
        'caused_by_timestamp': None,
        'dom_snapshot_path': 'storage\\snapshots\\60cb381ca86341f389cf8e869d033867\\2026-09-25T04-51-33-396Z.html',
        'act_target': None,
        'state_target': None,
        'dom_context': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:33.396Z',
        'delay_before_ms': 322,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'hover',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'xpath': '//main[.//h1[contains(text(), '
                                        "'Speakers')]]/div[3]/div/section/div/div[4]",
                               'text': 'COLOR\n'
                                       'Blue (43)\n'
                                       'Red (32)\n'
                                       'Black (28)\n'
                               ...
                               'cross_boundary': False,
                               'icon_class_hint': None},
        'bounding_box': {'x': 0, 'y': 601.4000244140625, 'width': 252, 'height': 258.6000061035156},
        'click_strategy': None,
        'wait_for_stable_state': None,
        'wait_for_stable_state_timeout_ms': None,
        'click_selector': None,
        ...
        'expect': {   'type': 'reveal',
                      'revealed_locator_profile': {   'id': None,
                                                      ...
                                                      'css_path': 'div#mountRoot > div > main > '
                                                                  ...
                                                                  'label > div',
                                                      'xpath': "//label[normalize-space(text())='Blue']/div",
                                                      'text': '',
                                                      'element_text': '',
                                                      'tag': 'div',
                                                      'attributes': {},
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:38.301Z',
        'delay_before_ms': 4905,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'check',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'role': 'checkbox',
                               'aria_label': None,
                               'accessible_name': 'Blue (43)',
                               'placeholder': None,
                               'title': None,
                               'href': None,
                               'product_id': None,
                               'css_path': 'div#mountRoot > div > main > div:nth-of-type(3) > div '
                                           '> section > div > div:nth-of-type(4) > ul > li > label',
                               'xpath': "//label[normalize-space(text())='Blue']",
                               'text': 'Blue (43)',
                               'element_text': 'Blue (43)',
                               'tag': 'label',
                               'attributes': {},
                               'cross_boundary': False,
                               'icon_class_hint': None},
        ...
        'state_target': {   'locator_profile': {   'id': None,
                                                   ...
                                                   'css_path': 'div#mountRoot > div > main > '
                                                               'div:nth-of-type(3) > div > section '
                                                               '> div > div:nth-of-type(4) > ul > '
                                                               'li > label > input',
                                                   'xpath': "//label[normalize-space(text())='Blue']/input",
                                                   'text': 'Blue (43)',
                                                   'element_text': 'Blue',
                                                   'tag': 'input',
                                                   'attributes': {'type': 'checkbox'},
                                                   ...
                                                   'icon_class_hint': None},
                            'checked': True},
        'dom_context': {   'act_target_html_chain': [   '<label class="common-customCheckbox" '
                                                        'data-count="43"><span '
                                                        'data-colorhex="blue" class="colour-label '
                                                        'colour-colorDisplay" '
                                                        'style="background-color: rgb(0, 116, '
                                                        '217);"></span><!-- react-text: 161 '
                                                        '-->Blue<!-- /react-text --><!-- '
                                                        'react-text: 162 --> <!-- /react-text '
                                                        '--><span class="colour-num"><!-- '
                                                        'react-text: 164 -->(<!-- /react-text '
                                                        '--><!-- react-text: 165 -->43<!-- '
                                                        '/react-text --><!-- react-text: 166 '
                                                        '-->)<!-- /react-text --></span><input '
                                                        'type="checkbox" value="Blue"><div '
                                                        'class="common-checkboxIndicator"></div></label>',
                                                        '<li class="colour-listItem"><label '
                                                        ...
                                                        'type="checkbox" value="Blue"><div '
                                                        'class="common-checkboxIndicator"></div></label></li>',
                                                        '<ul><li class="colour-listItem"><label '
                                                        'class="common-customCheckbox" '
                                                        'data-count="43"><span '
                                                        'data-colorhex="blue" class="colour-label '
                                                        'colour-colorDisplay" '
                                                        ...
                                                        '-->)<!-- /react-text --></span><input '
                                                        'type="checkbox" value="Blue"><div '
                                                        'class="common-checkboxIndicator"></div></label></li><li '
                                                        'class="colour-listItem"><label '
                                                        'class="common-customCheckbox" '
                                                        'data-count="32"><span data-colorhex="red" '
                                                        'class="colour-label '
                                                        'colour-colorDispl...[truncated]',
                                                        '<div '
                                                        'class="vertical-filters-filters"><span '
                                                        'class="vertical-filters-header">Color</span><div '
                                                        'class="filter-search-filterSearchBox"><input '
                                                        'type="text" class="filter-search-inputBox '
                                                        'filter-search-hidden" placeholder="Search '
                                                        'for Color"><span class="myntraweb-sprite '
                                                        'filter-search-iconSearch '
                                                        'sprites-search"></span></div><ul><li '
                                                        'class="colour-listItem"><label '
                                                        'class="common-customCheckbox" '
                                                        'data-count="43"><span '
                                                        'data-colorhex="blue" class="colour-label '
                                                        ...
                                                        '--><span class="colour-num"><!-- '
                                                        'react-text: 164 -->(<!-- /react-text '
                                                        '--><!-- react-text: 1...[truncated]',
                                                        '<div '
                                                        'class="condition-render-verticalFilters '
                                                        'condition-render-boundary-top"><div '
                                                        'class="vertical-filters-filters '
                                                        'header-container"><span '
                                                        'class="header-title">FILTERS</span><span '
                                                        'class="header-clearAllBtn">CLEAR '
                                                        'ALL</span></div><div '
                                                        'class="vertical-filters-filters '
                                                        'brand-container"><span '
                                                        'class="vertical-filters-header">Brand</span><div '
                                                        ...
                                                        'class="brand-list"><li><label '
                                                        'class="ver...[truncated]'],
                           'act_target_style': {   'display': 'inline',
                                                   'visibility': 'visible',
                                                   'opacity': '1'},
                           'state_target_html_chain': [   '<input type="checkbox" value="Blue">',
                                                          ...
                                                          'class="filter-search-inputBox '
                                                          'filter-search-hidden" '
                                                          'placeholder="Search for Color"><span '
                                                          'class="myntraweb-sprite '
                                                          'filter-search-iconSearch '
                                                          'sprites-search"></span></div><ul><li '
                                                          'class="colour-listItem"><label '
                                                          ...
                                                          'class="filter-search-inputBox '
                                                          'filter-search-hidden" '
                                                          'placeholder="Search for...[truncated]',
                                                          '<section><div '
                                                          'class="condition-render-verticalFilters '
                                                          'condition-render-boundary-top"><div '
                                                          'class="vertical-filters-filters '
                                                          ...
                                                          'class="filter-search-inputBox '
                                                          'filter-search-hidden" '
                                                          'placeholder="S...[truncated]'],
                           'state_target_style': {   'display': 'inline-block',
                                                     'visibility': 'hidden',
                                                     'opacity': '1'}},
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:38.303Z',
        'delay_before_ms': 2,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'confirmation_timeout_ms': None,
        'verification_timeout_ms': None,
        'page_url': 'https://www.myntra.com/speakers?f=Brand%3AMZ%3A%3AColor%3ABlue_0074D9',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        ...
        'expect': None,
        'caused_by_timestamp': None,
        'dom_snapshot_path': 'storage\\snapshots\\60cb381ca86341f389cf8e869d033867\\2026-09-25T04-51-38-562Z.html',
        'act_target': None,
        'state_target': None,
        'dom_context': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:38.562Z',
        'delay_before_ms': 259,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'click',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'xpath': "//label[normalize-space(.)='Net Quantity Unit']",
                               ...
                               'cross_boundary': False,
                               'icon_class_hint': None},
        'bounding_box': {   'x': 747.1625366210938,
                            'y': 172.40000915527344,
                            'width': 148.8249969482422,
        ...
        'act_target': {   'id': None,
                          ...
                          'icon_class_hint': None},
        'state_target': None,
        'dom_context': {   'act_target_html_chain': [   '<label class=""><input type="radio" '
                                                        'value="Net Quantity Unit"><h4 '
                                                        'class="atsa-title"><!-- react-text: 358 '
                                                        '-->Net Quantity Unit<!-- /react-text '
                                                        '--><!-- react-text: 359 --> <!-- '
                                                        '/react-text --></h4><span '
                                                        'class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        'myntraweb-sprite"></span></label>',
                                                        '<li><label class=""><input type="radio" '
                                                        'value="Net Quantity Unit"><h4 '
                                                        'class="atsa-title"><!-- react-text: 358 '
                                                        '-->Net Quantity Unit<!-- /react-text '
                                                        '--><!-- react-text: 359 --> <!-- '
                                                        ...
                                                        'class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        'myntraweb-sprite"></span></label></li>',
                                                        '<ul class="atsa-filters"><li><label '
                                                        'class=""><input type="radio" '
                                                        'value="Bundles"><h4 '
                                                        'class="atsa-title"><!-- react-text: 330 '
                                                        '-->Bundles<!-- /react-text --><!-- '
                                                        'react-text: 331 --> <!-- /react-text '
                                                        '--></h4><span class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        'myntraweb-sprite"></span></label></li><li><label '
                                                        'class=""><input type="radio" '
                                                        'value="Connectivity"><h4 '
                                                        'class="atsa-title"><!-- react-text: 337 '
                                                        '-->Connectivity<!-- /react-text --><!-- '
                                                        'react-text: 338 --> <!-- /react-text '
                                                        '--></h4><span class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        'myntraweb-sprite"></span></label></li><li><label '
                                                        'class=""><input type="radio" '
                                                        'value="Country of Origin"><h4 '
                                                        'class="atsa-title"><!-- react-text: 344 '
                                                        '-->Country of Origin<!-- /react-text '
                                                        '--><!-- react-text: 345 --> <!-- '
                                                        '/react-text --></h4><span '
                                                        'class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        ...
                                                        'class=""><input type="radio" '
                                                        'value="Microphone"><h4 '
                                                        'class="atsa-title"><!-- react-text: 351 '
                                                        '-->Microphone<!-- /react-text --><!-- '
                                                        'react-text: 352 --> <!-- /react-text '
                                                        '--></h4><span class="atsa-downArrow '
                                                        'sprites-arrowDownBold '
                                                        'myntraweb-sprite"></span></label></li><li><label '
                                                        'class=""><input type="radi...[truncated]',
                                                        '<div class="atsa-base"><ul '
                                                        'class="atsa-filters"><li><label '
                                                        'class=""><input type="radio" '
                                                        'value="Bundles"><h4 '
                                                        'class="atsa-title"><!-- react-text: 330 '
                                                        '-->Bundles<!-- /react-text --><!-- '
                                                        ...
                                                        'cla...[truncated]',
                                                        '<div><div '
                                                        'class="horizontal-filters-sortContainer"><div><div><div '
                                                        'class="sort-sortBy"><!-- react-text: 292 '
                                                        '-->Sort by : <!-- /react-text '
                                                        '--><span>Recommended</span><span '
                                                        'class="myntraweb-sprite sort-downArrow '
                                                        'sprites-downArrow"></span><ul '
                                                        'class="sort-list"><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="recommended"><!-- react-text: 299 '
                                                        '-->Recommended<!-- /react-text '
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="new"><!-- react-text: 303 '
                                                        "-->What's New<!-- /react-text "
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="popularity"><!-- react-text: 307 '
                                                        '-->Popularity<!-- /react-text '
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="discount"><!-- react-text: 311 '
                                                        '-->Better Discount<!-- /react-text '
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="price_desc"><!-- react-text: 315 '
                                                        '-->Price: High to Low<!-- /react-text '
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="price_asc"><!-- react-text: 319 '
                                                        '-->Price: Low to High<!-- /react-text '
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="Customer Rating"><!-...[truncated]',
                                                        '<section class="horizontal-filters-base '
                                                        'horizontal-filters-hideBorder '
                                                        'horizontal-filters-addBoxShadow"><div><div '
                                                        'class="horizontal-filters-sortContainer"><div><div><div '
                                                        'class="sort-sortBy"><!-- react-text: 292 '
                                                        '-->Sort by : <!-- /react-text '
                                                        '--><span>Recommended</span><span '
                                                        ...
                                                        '-->Price: Low to High<!-- '
                                                        '/re...[truncated]',
                                                        '<div class=" row-base" style="display: '
                                                        '-webkit-flex;"><section '
                                                        'class="horizontal-filters-base '
                                                        'horizontal-filters-hideBorder '
                                                        'horizontal-filters-addBoxShadow"><div><div '
                                                        'class="horizontal-filters-sortContainer"><div><div><div '
                                                        'class="sort-sortBy"><!-- react-text: 292 '
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:43.869Z',
        'delay_before_ms': 5307,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'hover',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:46.022Z',
        'delay_before_ms': 2153,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'check',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'css_path': 'div#desktopSearchResults > div > section > div > '
                                           ...
                                           'label',
                               'xpath': "//label[normalize-space(text())='Pieces']",
                               'text': 'Pieces',
                               'element_text': 'Pieces',
                               'tag': 'label',
                               'attributes': {},
        ...
        'act_target': {   'id': None,
                          ...
                          'product_id': None,
                          'css_path': 'div#desktopSearchResults > div > section > div > '
                                      'div:nth-of-type(2) > div > ul > li:nth-of-type(2) > label',
                          'xpath': "//label[normalize-space(text())='Pieces']",
                          'text': 'Pieces',
                          'element_text': 'Pieces',
                          'tag': 'label',
        ...
        'state_target': {   'locator_profile': {   'id': None,
                                                   ...
                                                   'icon_class_hint': None},
                            'checked': True},
        'dom_context': {   'act_target_html_chain': [   '<label '
                                                        'class="common-customCheckbox"><input '
                                                        'type="checkbox" value="Pieces"><!-- '
                                                        'react-text: 5389 -->Pieces<!-- '
                                                        '/react-text --><div '
                                                        'class="common-checkboxIndicator"></div></label>',
                                                        '<li><label '
                                                        'class="common-customCheckbox"><input '
                                                        ...
                                                        '/react-text --><div '
                                                        'class="common-checkboxIndicator"></div></label></li>',
                                                        '<ul class="atsa-values"><li><label '
                                                        'class="common-customCheckbox"><input '
                                                        'type="checkbox" value="Piece"><!-- '
                                                        'react-text: 5384 -->Piece<!-- /react-text '
                                                        '--><div '
                                                        'class="common-checkboxIndicator"></div></label></li><li><label '
                                                        'class="common-customCheckbox"><input '
                                                        'type="checkbox" value="Pieces"><!-- '
                                                        'react-text: 5389 -->Pieces<!-- '
                                                        '/react-text --><div '
                                                        'class="common-checkboxIndicator"></div></label></li></ul>',
                                                        '<div class="atsa-atsaFiltersOptionCtn '
                                                        'atsa-atsaShowContainer"><ul '
                                                        'class="atsa-values"><li><label '
                                                        'class="common-customCheckbox"><input '
                                                        'type="checkbox" value="Piece"><!-- '
                                                        'react-text: 5384 -->Piece<!-- /react-text '
                                                        '--><div '
                                                        ...
                                                        'react-text: 5389 -->Pieces<!-- '
                                                        '/react-text --><div '
                                                        'class="common-checkboxIndicator"></div></label></li></ul></div>',
                                                        '<div class="atsa-base"><ul '
                                                        'class="atsa-filters"><li><label '
                                                        'class=""><input type="radio" '
                                                        'value="Bundles"><h4 '
                                                        ...
                                                        '--></label></li><li><label '
                                                        'class="sort-label "><input type="radio" '
                                                        'value="popularity"><!-...[truncated]'],
                           'act_target_style': {   'display': 'inline',
                                                   'visibility': 'visible',
                                                   'opacity': '1'},
                           'state_target_html_chain': [   '<input type="checkbox" value="Pieces">',
                                                          '<label '
                                                          'class="common-customCheckbox"><input '
                                                          'type="checkbox" value="Pieces"><!-- '
                                                          'react-text: 5389 -->Pieces<!-- '
                                                          ...
                                                          'react-text: 5389 -->Pieces<!-- '
                                                          '/react-text --><div '
                                                          'class="common-checkboxIndicator"></div></label></li></ul></div...[truncated]',
                                                          '<div class="atsa-base"><ul '
                                                          'class="atsa-filters"><li><label '
                                                          'class=""><input type="radio" '
                                                          'value="Bundles"><h4 '
                                                          ...
                                                          '<div><div '
                                                          'class="horizontal-filters-sortContainer"><div><div><div '
                                                          'class="sort-sortBy"><!-- react-text: '
                                                          '292 -->Sort by : <!-- /react-text '
                                                          '--><span>Recommended</span><span '
                                                          'class="myntraweb-sprite sort-downArrow '
                                                          'sprites-downArrow"></span><ul '
                                                          'class="sort-list"><li><label '
                                                          'class="sort-label "><input type="radio" '
                                                          'value="recommended"><!-- react-text: '
                                                          '299 -->Recommended<!-- /react-text '
                                                          '--></label></li><li><label '
                                                          'class="sort-label "><input type="radio" '
                                                          'value="new"><!-- reac...[truncated]'],
                           'state_target_style': {   'display': 'inline-block',
                                                     'visibility': 'hidden',
                                                     'opacity': '1'}},
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:46.024Z',
        'delay_before_ms': 2,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'confirmation_timeout_ms': None,
        'verification_timeout_ms': None,
        'page_url': 'https://www.myntra.com/speakers?f=Brand%3AMZ%3A%3AColor%3ABlue_0074D9%3A%3ANet%20Quantity%20Unit%3APieces',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        ...
        'expect': None,
        'caused_by_timestamp': None,
        'dom_snapshot_path': 'storage\\snapshots\\60cb381ca86341f389cf8e869d033867\\2026-09-25T04-51-46-482Z.html',
        'act_target': None,
        'state_target': None,
        'dom_context': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:46.482Z',
        'delay_before_ms': 458,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'check',
        ...
        'locator_profile': {   'id': None,
                               ...
                               'xpath': "//label[normalize-space(text())='boAt']",
                               'text': 'boAt(4)',
                               'element_text': 'boAt(4)',
                               'tag': 'label',
                               'attributes': {},
        ...
        'state_target': {   'locator_profile': {   'id': None,
                                                   ...
                                                   'css_path': 'div#mountRoot > div > main > '
                                                               ...
                                                               'li > label > input',
                                                   'xpath': "//label[normalize-space(text())='boAt']/input",
                                                   'text': 'boAt(4)',
                                                   'element_text': 'boAt',
                                                   'tag': 'input',
                                                   'attributes': {'type': 'checkbox'},
        ...
        'dom_context': {   'act_target_html_chain': [   '<label class="vertical-filters-label '
                                                        ...
                                                        '<div class="vertical-filters-filters '
                                                        'brand-container"><span '
                                                        'class="vertical-filters-header">Brand</span><ul '
                                                        'class="brand-list"><li><label '
                                                        'class="vertical-filters-label '
                                                        'common-customCheckbox"><input '
                                                        'type="checkbox" value="boAt"><!-- '
                                                        ...
                                                        '/react-text --><!-- react-text: 70 '
                                                        '-->)<!-- /react-text --></span><div '
                                                        'class="common-checkboxIn...[truncated]',
                                                        '<div class="search-leftContainer '
                                                        'column-base" style="-webkit-box-flex: 1; '
                                                        'flex: 1 1 0%;"><section><div '
                                                        'class="condition-render-verticalFilters '
                           ...
                           'act_target_style': {   'display': 'block',
                                                   'visibility': 'visible',
                                                   'opacity': '1'},
                           'state_target_html_chain': [   '<input type="checkbox" value="boAt">',
                                                          '<label class="vertical-filters-label '
                                                          'common-customCheckbox"><input '
                                                          'type="checkbox" value="boAt"><!-- '
                                                          'react-text: 66 -->boAt<!-- /react-text '
                                                          ...
                                                          '/react-text --><!-- react-text: 70 '
                                                          '-->)<!-- /react-text --></span><div '
                                                          'class="common-checkboxIndi...[truncated]',
                                                          '<div '
                                                          'class="condition-render-verticalFilters '
                                                          'condition-render-boundary-top"><div '
                                                          'class="vertical-filters-filters '
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:48.223Z',
        'delay_before_ms': 1741,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
    ...
    {   'action_type': 'navigate',
        ...
        'confirmation_timeout_ms': None,
        'verification_timeout_ms': None,
        'page_url': 'https://www.myntra.com/speakers?f=Brand%3AMZ%2CboAt%3A%3AColor%3ABlue_0074D9%3A%3ANet%20Quantity%20Unit%3APieces',
        'delta_x': None,
        'delta_y': None,
        'scroll_y_before': None,
        'scroll_y_after': None,
        ...
        'expect': None,
        'caused_by_timestamp': None,
        'dom_snapshot_path': 'storage\\snapshots\\60cb381ca86341f389cf8e869d033867\\2026-09-25T04-51-48-605Z.html',
        'act_target': None,
        'state_target': None,
        'dom_context': None,
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:48.605Z',
        'delay_before_ms': 382,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
    ...
    {   'action_type': 'tab_close',
        ...
        'viewport_height': None,
        'document_height': None,
        'timestamp': '2026-09-25T04:51:55.501Z',
        'delay_before_ms': 6896,
        'new_tab': None,
        'page_id': 0,
        'from_page_id': None,
        'to_page_id': None,
...
SOURCE_NAME = "session_20260925_102127"
