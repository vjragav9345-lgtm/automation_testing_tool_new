...
def _run_pick_wait_phase(pick_id, browser, context, final_page, start_url, preceding_actions):
    ...
    try:
        ...
        actual_url = None
    url_mismatch = bool(expected_url and actual_url and expected_url != actual_url)
...
class _WarmPickSession:
    ...
    def _do_start_pick(self, pick_id, session_path, start_url, preceding_actions):
        ...
        try:
            _run_pick_wait_phase(pick_id, self.browser, self.context, final_page, start_url, preceding_actions)
        except Exception as e:
