"""
Auto-generated from recording: item6_name_check
Generated at: 2026-09-21T07:58:49.033014
...
Run directly with: python item6_name_check_script_v4.py [qa_url] [output_json_path] [screenshot_dir] [headless] [product_name]
...
STEPS = [   {   'action_type': 'click',
        'value': None,
        'locator_profile': {   'xpath': "//*[@id='route-btn']",
                               'tag': 'button',
        ...
        'attribute_name': None,
        'match_mode': None,
        'name': 'My Custom Renamed Step'},
    {   'action_type': 'check',
        'value': None,
        'locator_profile': {   'xpath': "//*[@id='agree-checkbox']",
                               'tag': 'input',
...
def _derive_action_name(action):
    ...
    label = (
        (lp.get("text") or "").split("\n")[0].strip()
        or (lp.get("accessible_name") or "").strip()
